...
public abstract class Hilt_FilePushWizardFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FilePushWizardFragment() {
    super();
  }

  Hilt_FilePushWizardFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FilePushWizardFragment_GeneratedInjector) this.generatedComponent()).injectFilePushWizardFragment(UnsafeCasts.<FilePushWizardFragment>unsafeCast(this));
    }
  }
