...
public abstract class Hilt_TaskDetailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TaskDetailFragment() {
    super();
  }

  Hilt_TaskDetailFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TaskDetailFragment_GeneratedInjector) this.generatedComponent()).injectTaskDetailFragment(UnsafeCasts.<TaskDetailFragment>unsafeCast(this));
    }
  }
