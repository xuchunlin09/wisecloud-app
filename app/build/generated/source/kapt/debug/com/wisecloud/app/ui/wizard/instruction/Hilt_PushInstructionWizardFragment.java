...
public abstract class Hilt_PushInstructionWizardFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PushInstructionWizardFragment() {
    super();
  }

  Hilt_PushInstructionWizardFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PushInstructionWizardFragment_GeneratedInjector) this.generatedComponent()).injectPushInstructionWizardFragment(UnsafeCasts.<PushInstructionWizardFragment>unsafeCast(this));
    }
  }
