...
public abstract class Hilt_DeviceListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DeviceListFragment() {
    super();
  }

  Hilt_DeviceListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DeviceListFragment_GeneratedInjector) this.generatedComponent()).injectDeviceListFragment(UnsafeCasts.<DeviceListFragment>unsafeCast(this));
    }
  }
