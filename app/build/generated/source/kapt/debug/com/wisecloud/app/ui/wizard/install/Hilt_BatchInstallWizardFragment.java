...
public abstract class Hilt_BatchInstallWizardFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BatchInstallWizardFragment() {
    super();
  }

  Hilt_BatchInstallWizardFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BatchInstallWizardFragment_GeneratedInjector) this.generatedComponent()).injectBatchInstallWizardFragment(UnsafeCasts.<BatchInstallWizardFragment>unsafeCast(this));
    }
  }
