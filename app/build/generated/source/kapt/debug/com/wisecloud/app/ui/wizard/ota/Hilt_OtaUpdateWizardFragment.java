...
public abstract class Hilt_OtaUpdateWizardFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_OtaUpdateWizardFragment() {
    super();
  }

  Hilt_OtaUpdateWizardFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OtaUpdateWizardFragment_GeneratedInjector) this.generatedComponent()).injectOtaUpdateWizardFragment(UnsafeCasts.<OtaUpdateWizardFragment>unsafeCast(this));
    }
  }
