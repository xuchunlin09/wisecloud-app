...
public abstract class Hilt_DeviceDetailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DeviceDetailFragment() {
    super();
  }

  Hilt_DeviceDetailFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DeviceDetailFragment_GeneratedInjector) this.generatedComponent()).injectDeviceDetailFragment(UnsafeCasts.<DeviceDetailFragment>unsafeCast(this));
    }
  }
