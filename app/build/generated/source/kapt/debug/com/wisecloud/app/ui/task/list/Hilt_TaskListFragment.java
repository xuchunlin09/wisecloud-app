...
public abstract class Hilt_TaskListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TaskListFragment() {
    super();
  }

  Hilt_TaskListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TaskListFragment_GeneratedInjector) this.generatedComponent()).injectTaskListFragment(UnsafeCasts.<TaskListFragment>unsafeCast(this));
    }
  }
