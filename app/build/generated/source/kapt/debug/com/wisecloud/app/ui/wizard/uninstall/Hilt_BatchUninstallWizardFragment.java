...
public abstract class Hilt_BatchUninstallWizardFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BatchUninstallWizardFragment() {
    super();
  }

  Hilt_BatchUninstallWizardFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BatchUninstallWizardFragment_GeneratedInjector) this.generatedComponent()).injectBatchUninstallWizardFragment(UnsafeCasts.<BatchUninstallWizardFragment>unsafeCast(this));
    }
  }
