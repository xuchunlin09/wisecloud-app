...
public abstract class Hilt_WiseOSSettingWizardFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_WiseOSSettingWizardFragment() {
    super();
  }

  Hilt_WiseOSSettingWizardFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WiseOSSettingWizardFragment_GeneratedInjector) this.generatedComponent()).injectWiseOSSettingWizardFragment(UnsafeCasts.<WiseOSSettingWizardFragment>unsafeCast(this));
    }
  }
