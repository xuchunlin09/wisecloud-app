...
public final class DaggerWiseCloudApp_HiltComponents_SingletonC {
  ...
  private static final class ViewModelCImpl extends WiseCloudApp_HiltComponents.ViewModelC {
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.taskDetailViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 9);
      this.taskListViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 10);
      this.wiseOSSettingViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 11);
    }

    @Override
    public Map<String, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return MapBuilder.<String, javax.inject.Provider<ViewModel>>newMapBuilder(12).put("com.wisecloud.app.ui.wizard.install.BatchInstallViewModel", ((Provider) batchInstallViewModelProvider)).put("com.wisecloud.app.ui.wizard.uninstall.BatchUninstallViewModel", ((Provider) batchUninstallViewModelProvider)).put("com.wisecloud.app.ui.dashboard.DashboardViewModel", ((Provider) dashboardViewModelProvider)).put("com.wisecloud.app.ui.device.detail.DeviceDetailViewModel", ((Provider) deviceDetailViewModelProvider)).put("com.wisecloud.app.ui.device.list.DeviceListViewModel", ((Provider) deviceListViewModelProvider)).put("com.wisecloud.app.ui.wizard.filepush.FilePushViewModel", ((Provider) filePushViewModelProvider)).put("com.wisecloud.app.ui.auth.LoginViewModel", ((Provider) loginViewModelProvider)).put("com.wisecloud.app.ui.wizard.ota.OtaUpdateViewModel", ((Provider) otaUpdateViewModelProvider)).put("com.wisecloud.app.ui.wizard.instruction.PushInstructionViewModel", ((Provider) pushInstructionViewModelProvider)).put("com.wisecloud.app.ui.task.detail.TaskDetailViewModel", ((Provider) taskDetailViewModelProvider)).put("com.wisecloud.app.ui.task.list.TaskListViewModel", ((Provider) taskListViewModelProvider)).put("com.wisecloud.app.ui.wizard.wiseos.WiseOSSettingViewModel", ((Provider) wiseOSSettingViewModelProvider)).build();
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 9: // com.wisecloud.app.ui.task.detail.TaskDetailViewModel 
          return (T) new TaskDetailViewModel(singletonCImpl.taskRepositoryImplProvider.get());

          case 10: // com.wisecloud.app.ui.task.list.TaskListViewModel 
          return (T) new TaskListViewModel(singletonCImpl.taskRepositoryImplProvider.get());

          case 11: // com.wisecloud.app.ui.wizard.wiseos.WiseOSSettingViewModel 
